...
indir   = '../img_inputs/Lonar/Lonar_Right_03_wide_b_100x200/'; % input directory for arrays


%% Make background temperature and porosity from an array (make array using ImgPrep_Temperature.m and ImgPrep_Porosity.m)
TArr   = load([indir 'Lonar_Right_03_wide_b_100x200_TArray.mat']);
...
cbrc = imread(indir + "Lonar_Right_03_wide_b_100x200_Lith_4.png"); % Binary image showing location of Coarse Breccia
sed  = imread(indir + "Lonar_Right_03_wide_b_100x200_Lith_5.png"); % Binary image showing location of Sediments
bslt_pdr = imread(indir + "Lonar_Right_03_wide_b_100x200_Lith_7.png"); % Binary image showing location of Powdered Basalt
mbrc = imread(indir + "Lonar_Right_03_wide_b_100x200_Lith_8.png"); % Binary image showing location of Micro Breccia

bslt = imread(indir + "Lonar_Right_03_wide_b_100x200_Lith_2.png"); % Binary image showing location of Basalt
bsmt = imread(indir + "Lonar_Right_03_wide_b_100x200_Lith_1.png"); % Binary image showing location of Basement
wat  = imread(indir + "Lonar_Right_03_wide_b_100x200_Lith_6.png"); % Binary image showing location of Water
