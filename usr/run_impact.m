...
dC      = 1.e-4;    % perturbation amplitude [wt]
...
Tstruct = [500];    % temperature of structures (nan = do not set)
Cstruct = [0.01];   % salinity of structures (nan = do not set)

smth    = 20*(N/100)^2; % smoothness of initial fields
