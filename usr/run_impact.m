...
Nx      = 3000;      % num. grid size in z-direction 

Nzi     = 50;      % num. grid size in z-direction
Nxi     = 300;      % num. grid size in x-direction
D       = 20e3;      % physical domain depth [m]

indir   = '../img_inputs/Sudbury/Sudbury_R_20x120km_500x3000/'; % input directory for arrays
...
TArr   = load([indir 'Sudbury_R_20x120km_500x3000_TArray.mat']);
