...
runID   = 'Lonar_Right_04_4'; % run identifier tag
...
imgName_T      = "../img_inputs/Lonar/Lonar_Full_Temperature_2.png";  % Filename of the temperature distribution
...
C_wat =  0.0;   % Water salinity (wt fraction, sea water is 3.5% (0.035), set to nan to evolve as mixed reservoir)
